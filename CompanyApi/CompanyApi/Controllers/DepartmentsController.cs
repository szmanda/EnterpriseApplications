    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<DepartmentDTO>>> GetDepartments()
        {
            return await _context.Departments
                .Select(d => DepartmentDTO.DepartmentToDTO(d))
                .ToListAsync();
        }
        ...
        public async Task<IActionResult> PutDepartment(int id, DepartmentDTO departmentDTO)
        {
            ...
            _context.Entry(DepartmentDTO.DTOToDepartment(departmentDTO)).State = EntityState.Modified;
        ...
        {
            _context.Departments.Add(DepartmentDTO.DTOToDepartment(departmentDTO));
            await _context.SaveChangesAsync();
